...
GibbsRFLSM <- function(Y, H = NULL, X = NULL, q = 5, 
  ...
  out <- list(
    "Phi" = matrix(model$Phi, ncol = nsim, byrow = TRUE),
    "Beta" = matrix(Beta, ncol = nsim, byrow = TRUE),
    "pBeta" = matrix(pBeta, ncol = nsim, byrow = TRUE),
    "Kappa" = matrix(Kappa, ncol = nsim, byrow = TRUE),
    "Gamma" = matrix(Gamma, ncol = nsim, byrow = TRUE),
    "pGamma" = matrix(pGamma, ncol = nsim, byrow = TRUE),
    "Tau" = matrix(Tau, ncol = nsim, byrow = TRUE),
    "sigma2" = model$sigma2,
