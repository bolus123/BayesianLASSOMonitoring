...
#' 
GibbsRFLSM1 <- function(Y, q, A, a, b, alpha, beta, theta1, theta2, tau0flg, xi2, method, bound0, boundqplus1, nsim, by, burnin, tol, H = NULL) {
    .Call(`_BayesianLassoMonitoring_GibbsRFLSM1`, Y, q, A, a, b, alpha, beta, theta1, theta2, tau0flg, xi2, method, bound0, boundqplus1, nsim, by, burnin, tol, H)
}
